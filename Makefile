...
C_SOURCES =  \
		...
		${wildcard $(TOP_DIR)/kernel/portable/ThirdParty/GCC/Posix/*.c} \
		${wildcard $(TOP_DIR)/kernel/portable/ThirdParty/GCC/Posix/utils/*.c} \
		${wildcard $(TOP_DIR)/kernel/portable/MemMang/heap_3.c} \
		${wildcard $(TOP_DIR)/*.c} \
...
C_INCLUDES = \
		...
		-I $(TOP_DIR)/kernel/portable/ThirdParty/GCC/Posix \
		-I $(TOP_DIR)/kernel/portable/ThirdParty/GCC/Posix/utils \
		-I $(TOP_DIR)
